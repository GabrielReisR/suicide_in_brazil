...
date: "Última atualização: 11/05/2021"
output: 
  html_document:
    toc: true
    toc_float: true
...
anos de educação foi o que mais cometeu suicídio, totalizando 32,35% dos casos.
Esse grupo equivale às pessoas com ensino fundamental I completo ou ensino
...
* A maioria dos suicídios ocorrem nas próprias casas (60,89% dos casos).
...
## Resumo geral
Esse trabalho buscou delinear características demográficas da população
que cometeu suicídio entre os anos de 2010 e 2019 no Brasil.
